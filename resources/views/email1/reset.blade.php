...
<title>Mclinch | Reset Credentials</title>
</head>
<body>
<center>
...
<tr>
	...
	<span style="font-size:25px; font-family:Trebuchet MS, Verdana, Arial; color:#2e8a3b;">Forget?</span>
	</td>
	...
	<span style="color:#FFFFFF; font-size:18px; font-family:Trebuchet MS, Verdana, Arial;">Login credentials</span>
	</td>
</tr>
...
<tr>
	...
	<span style="font-family:Trebuchet MS, Verdana, Arial; font-size:17px; font-weight:bold;">We are happy to help you!</span>
	<br />
	<p>Following are the credentials for MClinch account:</p>
	<br />
	<div style="padding-left:20px; padding-bottom:10px;"><img src="{{url('images/spade.gif')}}" alt=""/>&nbsp;&nbsp;&nbsp;USERID: {{$user[0]->user}}</div>

	<div style="padding-left:20px; padding-bottom:10px;"><img src="{{url('images/spade.gif')}}" alt=""/>&nbsp;&nbsp;&nbsp;PASSWORD: {{$user[0]->password}}</div>
	<div style="padding-left:20px; padding-bottom:10px;"><img src="{{url('images/spade.gif')}}" alt=""/>&nbsp;&nbsp;&nbsp;EMAIL: {{$user[0]->email}}</div>

	<p>In the meantime, you can <a href="http://mclinch.com">return to my website</a> to continue browsing.</p>
   ...
   This welcome email was sent to {{$user[0]->email}} because you recently signed up for occasional messages from www.mclinch.com
	...
	<img src="{{url('images/addressbook.gif')}}" align="right" style="padding-left:10px; padding-top:10px; padding-bottom:10px;" alt=""/>
	<p>To help ensure that you receive all email messages consistently in your inbox with images displayed, please add this address to your address book or contacts list: <strong>support@mclinch.com</strong>.</p>
	<br />
	</td>
	</tr>
	</table>
	...
	<img src="{{url('images/penpaper.gif')}}" align="right" style="padding-left:10px; padding-top:10px; padding-bottom:10px;" alt=""/>
	...
	<img src="{{url('images/lightbulb.gif')}}" align="right" style="padding-left:10px; padding-top:10px; padding-bottom:10px;" alt=""/>
...
<tr>
	...
	<a href="http://mclinch.com">Unsubscribe </a>
	</td>
</tr>
</table>
</center>
