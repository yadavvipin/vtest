...
<tr>
	...
	<span style="color:#FFFFFF; font-size:18px; font-family:Trebuchet MS, Verdana, Arial;">Congrats {{$user[0]->user}}!</span>
	</td>
</tr>
...
<tr>
	...
	<span style="font-family:Trebuchet MS, Verdana, Arial; font-size:17px; font-weight:bold;">Your advertise has been created.</span>
	<br />
	<p>It is in approval stage from MClinch Team.</p>
        <p>Once it is approved, Your advertise will be ready to display.</p>
	<br />
	
	<div style="padding-left:20px; padding-bottom:10px;"><img src="{{url('images/spade.gif')}}" alt=""/>&nbsp;&nbsp;&nbsp;You can manage your account by using {{$user[0]->email}}.</div>
